...
public class App
{
    public static void main( String[] args )
    {
        ...
        basket.add(new Cd(6, "LP", 32.99, 2000));
        basket.add(new Book(7, "Harry P", 199.99, 200));

        basket.add(new Poster(16, "Poster 1", 65.25));
        basket.add(new Poster(17, "Poster 2", 10.02));
        basket.add(new Poster(18, "Poster 3", 16.23));
